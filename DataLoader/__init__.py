...
params_dict = {
    'imagenet': {
        'train_dir': os.path.expanduser('/home/tuanvovan/ZiCo/dataset/imagenet/train/'),
        'val_dir': os.path.expanduser('/home/tuanvovan/ZiCo/dataset/imagenet/val/'),
        'num_train_samples': 130000,
