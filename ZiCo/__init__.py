...
# def get_ZiCo(model_name, c,pretrained=False, ckptpath=None):
...
#     model_plainnet_str_txt = os.path.join(this_script_dir,c)
#     if ckptpath is None:
...
ZiCo_model_zoo = {
    'ZiCo_imagenet1k_flops450M_res224_base': {
        'plainnet_str_txt': 'ZiCo_imagenet1k_flops450M_res224_base.txt',
        'pth_path': 'ZiCo_imagenet1k_flops450M_res224/student_best-params_rank0.pth',
        'num_classes': 100,
        'use_SE': True,
        'resolution': 224,
    ...
    'ZiCo_imagenet1k_flops450M_res224_from_layer3': {
        'plainnet_str_txt': 'ZiCo_imagenet1k_flops450M_res224_from_layer3.txt',
        'pth_path': 'ZiCo_imagenet1k_flops450M_res224/student_best-params_rank0.pth',
        'num_classes': 100,
        'use_SE': True,
        'resolution': 224,
    ...
    'Synflow_imagenet1k_flops450M_res224_from_layer3': {
        'plainnet_str_txt': 'Synflow_imagenet1k_flops450M_res224_from_layer3.txt',
        'pth_path': 'ZiCo_imagenet1k_flops450M_res224/student_best-params_rank0.pth',
        'num_classes': 100,
        'use_SE': True,
        'resolution': 224,
    ...
    'Synflow_imagenet1k_flops450M_res224_base': {
        'plainnet_str_txt': 'Synflow_imagenet1k_flops450M_res224_base.txt',
        'pth_path': 'ZiCo_imagenet1k_flops450M_res224/student_best-params_rank0.pth',
        'num_classes': 100,
        'use_SE': True,
        'resolution': 224,
    ...
    'Grad_imagenet1k_flops450M_res224_base': {
        'plainnet_str_txt': 'Grad_imagenet1k_flops450M_res224_base.txt',
        'pth_path': 'ZiCo_imagenet1k_flops450M_res224/student_best-params_rank0.pth',
        'num_classes': 100,
        'use_SE': True,
        'resolution': 224,
    ...
    'Grad_imagenet1k_flops450M_res224_from_layer2': {
        'plainnet_str_txt': 'Grad_imagenet1k_flops450M_res224_from_layer2.txt',
        'pth_path': 'ZiCo_imagenet1k_flops450M_res224/student_best-params_rank0.pth',
        'num_classes': 100,
        'use_SE': True,
        'resolution': 224,
