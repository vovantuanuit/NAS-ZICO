...
horovodrun -np 2 python ts_train_image_classification.py --dataset imagenet --num_classes 100 \
  ...
  --batch_size_per_gpu 128 --save_dir ${save_dir}/ts_effnet_b3ns_epochs${epochs} \
  --world-size 8 \
  --dist_mode horovod\
